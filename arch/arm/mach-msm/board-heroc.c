...
static struct msm_camsensor_device_platform_data heroc_s5k3e2fx_sensor_info = {
	.sensor_i2c_read = heroc_s5k3e2fx_i2c_read,
	.sensor_i2c_write = heroc_s5k3e2fx_i2c_write,
	.sensor_probe_initial = heroc_s5k3e2fx_probe_init,
	.sensor_deinit = heroc_s5k3e2fx_sensor_deinit,
	.sensor_write_exposuregain =  heroc_s5k3e2fx_write_exposuregain,
	.sensor_set_pclk = heroc_s5k3e2fx_set_pclk,
	.sensor_setting = heroc_s5k3e2fx_sensor_setting,
	.sensor_late_resume = heroc_s5k3e2fx_late_resume,
	.sensor_resume = heroc_s5k3e2fx_resume,
	.sensor_suspend = heroc_s5k3e2fx_suspend,
	.sensor_power_down = heroc_s5k3e2fx_power_down,
	.sensor_power_up = heroc_s5k3e2fx_power_up,
	.msmclk_rate_set = heroc_msm_camio_clk_rate_set,
	.msmclk_disable = heroc_msm_camio_clk_disable,
	.msmclk_enable = heroc_msm_camio_clk_enable,
	.msmclk_camif_clk_select = heroc_camif_clk_select,
	.msmio_camif_pad_reg_reset = heroc_s5k3e2fx_camif_pad_reg_reset,
	.msmio_camif_app_reset = heroc_s5k3e2fx_camif_app_reset,
	.msmio_camif_Reset2 = heroc_s5k3e2fx_camif_reset2,
};


static struct msm_camera_device_platform_data heroc_s5k3e2fx_device_data = {
	.sensor_reset	= HEROC_GPIO_CAM_RST_N,
	.sensor_pwd	= HEROC_CAM_PWDN,
	.vcm_pwd	= HEROC_GPIO_VCM_PWDN,
	.config_gpio_on = config_heroc_camera_on_gpios,
	.config_gpio_off = config_heroc_camera_off_gpios,
	.sensor_info =	&heroc_s5k3e2fx_sensor_info,
...
static struct i2c_board_info i2c_s5k3e2fx = {
	...
	.platform_data = &heroc_s5k3e2fx_device_data,
};
...
static uint32_t gpio_table[] = {
	...
	PCOM_GPIO_CFG(HEROC_GPIO_UART1_RTS, 2, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_8MA), /* RTS */
	PCOM_GPIO_CFG(HEROC_GPIO_UART1_CTS, 2, GPIO_INPUT, GPIO_PULL_UP, GPIO_8MA), /* CTS */
	PCOM_GPIO_CFG(HEROC_GPIO_UART1_RX, 2, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_8MA), /* RX */
	PCOM_GPIO_CFG(HEROC_GPIO_UART1_TX, 3, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_8MA), /* TX */
	#else
	PCOM_GPIO_CFG(HEROC_GPIO_UART1_RTS, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_4MA), /* RTS */
	PCOM_GPIO_CFG(HEROC_GPIO_UART1_CTS, 1, GPIO_INPUT, GPIO_PULL_UP, GPIO_4MA), /* CTS */
	PCOM_GPIO_CFG(HEROC_GPIO_UART1_RX, 1, GPIO_INPUT, GPIO_PULL_UP, GPIO_4MA), /* RX */
	PCOM_GPIO_CFG(HEROC_GPIO_UART1_TX, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_4MA), /* TX */
	#endif
};
