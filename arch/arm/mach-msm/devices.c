...
#ifdef CONFIG_MACH_HEROC || CONFIG_MACH_DESIREC
	.isCDMA = 1,
#else
	.isCDMA = 0,
#endif
...
/*
static struct android_pmem_platform_data pmem_ciq4_pdata = {
	.name = "pmem_ciq4",
	.no_allocator = 0,
	.cached = 0,
};
...
/*
static struct platform_device pmem_ciq4_device = {
	.name = "android_pmem",
	.id = 9,
	.dev = { .platform_data = &pmem_ciq4_pdata },
};
*/
#endif
...
/*
	if(setting->pmem_ciq4_size) {
		pmem_ciq4_pdata.start = setting->pmem_ciq4_start;
		pmem_ciq4_pdata.size = setting->pmem_ciq4_size;
		platform_device_register(&pmem_ciq4_device);
	}
*/
#endif
}
